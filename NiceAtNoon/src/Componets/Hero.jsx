  ...
  return (
    <div className="mt-12">
      ...
      <div className="mb-10 w-full px-5 font-normal text-2xl leading-tight tracking-tight md:px-10 lg:w-[90%] lg:text-3xl">
        ...
        -driven design; het geeft joyouw younieke merkverhaal geloofwaardigheid,
        zeggingskracht e
        <Button text="Get to know us" style="w-fit" />
      </div>
    </div>
  );
};
